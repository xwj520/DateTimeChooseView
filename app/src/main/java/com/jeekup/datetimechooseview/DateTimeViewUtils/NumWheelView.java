...
public class NumWheelView extends View {
	 ...
	 * 当前选中项  的 文字 的 颜色 
	 */
	private static final int VALUE_TEXT_COLOR = 0xFF33b5e5;
	 ...
	 * 选项 的 文字 的 颜色 
	 */
	private static final int ITEMS_TEXT_COLOR = 0xaa656565;
...
//			0x00EEEED5, 0x00EEEED5 };
	 ...
	 */
	private static final int ADDITIONAL_ITEM_HEIGHT =100;
	 ...
	 * 控件改变监听器的 集合
	 */
	private List<OnNumWheelChangedListener> changingListeners = new LinkedList<OnNumWheelChangedListener>();
	/**
	 * Listeners
	 *
	 *  </br>
	 * 控件滚动监听器的 集合
	 */
	private List<OnNumWheelScrollListener> scrollingListeners = new LinkedList<OnNumWheelScrollListener>();
	 ...
	 * 添加控件改变监听器
	 */
	public void addChangingListener(OnNumWheelChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnNumWheelChangedListener listener : changingListeners) {
	 ...
	 * 添加控件滚动监听器
	 */
	public void addScrollingListener(OnNumWheelScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnNumWheelScrollListener listener : scrollingListeners) {

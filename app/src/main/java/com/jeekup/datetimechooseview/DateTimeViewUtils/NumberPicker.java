...
public class NumberPicker extends View {
	...
	private void readAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mTextColor = a.getColor(R.styleable.NumberPicker_textColor_np, DEFAULT_TEXT_COLOR);
		mTextSize = a.getDimension(R.styleable.NumberPicker_textSize_np, DEFAULT_TEXT_SIZE * mDensity);
	...
	public interface OnScrollListener {
         ...
         *
         * @paramview The view whose scroll state is being reported.

...
public class DatePicker extends LinearLayout implements NumberPicker.OnValueChangeListener {
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth, int dayofweek);
    }
    ...
    private void notifyDateChanged() {
    	if (mOnDateChangedListener != null) {
    		mOnDateChangedListener.onDateChanged(this, getYear(), getMonth(), getDayOfMonth(), getDayOfWeek());
    	}
    }
    ...
    public int getDayOfWeek(){
    	return mCalendar.get(Calendar.DAY_OF_WEEK_IN_MONTH);
    }
